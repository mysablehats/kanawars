...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "kanawars.py"
 
        #Name of program
        self.project_name = "Kana Wars"
 
        #Project url
        self.project_url = "about:none"
 
        #Version of program
        self.project_version = "0.04"
 
        #License of the program
        self.license = "Free"
 
        #Auhor of program
        self.author_name = u"筆彦"
        self.author_email = "mysablehats@gmail.com"
        self.copyright = "Copyright (c) 2015 Nope."
 
        #Description
        self.project_description = "Simple kana game"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ["fonts-japanese-gothic.ttf", "Cyberbit.ttf", "background.png", "awesomesm.png", "bo.png", "death.jpg", "angel.png", "instruc.png", "An_8_Bit_Story.ogg", "Masterofpuppets.ogg", "Lilium_Music_Box_(convert).ogg"]
